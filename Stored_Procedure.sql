...
BEGIN
    BEGIN TRY
        ...
        BEGIN
			DECLARE @precioUniElectronicoSt varchar(50)
			SET @precioUniElectronicoSt = CAST(@precioUniElectronico as varchar(50))
            RAISERROR('Ya existe un producto electrónico con el mismo nombre y precio. Nombre: %s, Precio: %s.', 
                        16, 1, @productoElectronicoNombre,@precioUniElectronicoSt );
            RETURN;
        END
